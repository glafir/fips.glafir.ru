...
class OrgsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create org" do
    assert_difference('Org.count') do
      post orgs_url, params: { org: { create: @org.create, fullname: @org.fullname, org_state_id: @org.org_state_id, shortname: @org.shortname } }
    end
  ...
  test "should update org" do
    patch org_url(@org), params: { org: { create: @org.create, fullname: @org.fullname, org_state_id: @org.org_state_id, shortname: @org.shortname } }
