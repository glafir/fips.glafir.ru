...
class ProxiesControllerTest < ActionController::TestCase
  ...
  test "should create proxy" do
    assert_difference('Proxy.count') do
      post :create, proxy: { proxy_address: @proxy.proxy_address, proxy_status: @proxy.proxy_status, proxy_timeout: @proxy.proxy_timeout }
    end
  ...
  test "should update proxy" do
    patch :update, id: @proxy, proxy: { proxy_address: @proxy.proxy_address, proxy_status: @proxy.proxy_status, proxy_timeout: @proxy.proxy_timeout }
    assert_redirected_to proxy_path(assigns(:proxy))
  end
